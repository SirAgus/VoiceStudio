...
_BASE_SCHEMA = """
    ...
    CREATE INDEX IF NOT EXISTS idx_gemma4_threads_updated ON gemma4_threads(updated_at DESC);
    CREATE INDEX IF NOT EXISTS idx_gemma4_messages_thread ON gemma4_messages(thread_id, seq);
